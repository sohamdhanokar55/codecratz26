...
const partners: Partner[] = [
  {
    ...
    logo: "CcubeMedia.webp",
    website: "https://ccubemedia.in/",
    category: "Media",
  },
  // {
  //   name: "Google",
  ...
  return (
    <section id="partners" className="py-20 relative">
      <div className="container mx-auto px-6">
        ...
        {/* Partners Grid */}
        <div
          className={`${partners.length === 1 ? "flex justify-center" : "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4"} gap-8 max-w-6xl mx-auto`}
        >
          {partners.map((partner, index) => (
            <Card
              key={index}
              className="card-gradient group cursor-pointer overflow-hidden hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20 w-64"
